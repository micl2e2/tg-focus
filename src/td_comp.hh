...
using TdTxtEntItalic = tapi::textEntityTypeItalic;
using TdTxtEntCode = tapi::textEntityTypeCode;
using TdTxtEntUrl = tapi::textEntityTypeUrl;
using TdTxtEntTxtUrl = tapi::textEntityTypeTextUrl;
using TdTxtEntQuote = tapi::textEntityTypeBlockQuote;
using TdTxtEntExpQuote = tapi::textEntityTypeExpandableBlockQuote;
...
using TdLinkPrevOpt = tapi::linkPreviewOptions;
